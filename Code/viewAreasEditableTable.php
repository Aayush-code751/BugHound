...
<body class="bg-dark" style=" margin-top: 30px;">
       ...
       -->
        ...
        <tr>
        <th style="padding-left: 120px;">Area_id</th>
        <th style="padding-left: 50px;">Program Name</th>
        <th style="padding-left: 80px;">prog_id</th>
        <th style="padding-left: 90px;">Area</th>
        ...
        <center>                   
                            <?php 
                                        ...
                                        From areas 
                                        Left JOIN programs
                                        ON areas.prog_id = programs.prog_id";
                            ...
                            <form   name="areaForm" method="POST"  action="update_or_deleteAreas.php">
                               <table>
                                       <tr id="<?php $row['area_id']; ?>">
                                           ...
                                           <select  name="prog_id"  style="width:170px">
                                           
                                         <option>  <?php echo $row['prog_id'];?></option>
 <!-- in the above option i am displaying the prog_id that is currently assigned to this area 
in Below php when i click the select option the dropdown should not show me the repeated value so in my query i wont display the prog_id that is already ddisplayed in the above option. -->
                         <?php 
                                require_once("connection_to_root.php");
                                $prog_id_var= $row['prog_id'];
                                $queryInner = " SELECT * From programs where prog_id <> '".$prog_id_var."' ";
                         ...
                         ?>
                                ...
                                <?php echo $rowInner['prog_id'].' - '.$rowInner['program'].' - '.$rowInner['program_release'].' - '.$rowInner['program_version'];?>
                                </option>
